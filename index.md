...
Software is written, copied, edited, forked, and revised. It carries variants, witnesses, and emendations exactly as a literary text does, and like a literary text it can be read closely or read comparatively. Yet the apparatus that philology built over centuries for exactly this work, the witness, the siglum, the copy-text, the *apparatus criticus*, the collation, has not been brought to bear on code, on corpora, or on machine-generated text. The interpretive traditions and the computational artefacts have stayed in separate rooms.
