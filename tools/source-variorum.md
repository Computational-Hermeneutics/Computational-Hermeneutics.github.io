...
Version 0.5.x. Source code and text modes are live, with the transposition braid, the five variant types plus fuzzy variant, and the auto-generated critical apparatus. Support for three or more witnesses is a later phase. See the repository for the current state of each capability.
